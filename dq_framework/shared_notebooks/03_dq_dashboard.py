...
# MAGIC %md
# MAGIC # DQ Dashboard (shared)
# MAGIC
# MAGIC Parameterised notebook shared across all DQ entities.
# MAGIC All queries filter by source_table = target_table to isolate entity results.
...
print("=" * 70)
print(f"  BREACH REGISTER - {target_table} - Rules below threshold")
print("=" * 70)
