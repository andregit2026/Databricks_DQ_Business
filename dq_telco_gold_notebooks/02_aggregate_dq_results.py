...
# MAGIC Reads the enriched telco_gold_dq table, aggregates RELEVANT and positive
...
# MAGIC dq_rule_no identifies the rule (e.g. DQ_301_UNIQUE_IDENTIFIER_cust_id).
