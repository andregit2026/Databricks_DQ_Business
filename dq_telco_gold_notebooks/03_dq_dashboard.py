...
print("=" * 70)
print("  DQ DASHBOARD - Overall Summary - telco_gold")
print("=" * 70)
...
spark.sql(f"""
    ...
    WHERE m.source_table = 'telco_gold'
...
print("=" * 70)
print("  DQ DASHBOARD - Per Category - telco_gold")
print("=" * 70)
...
print("=" * 70)
print("  DQ DASHBOARD - Per Rule Detail - telco_gold")
print("=" * 70)
...
print("=" * 70)
print("  BREACH REGISTER - telco_gold - Rules below threshold")
print("=" * 70)
