...
# MAGIC Reads the enriched customer_gold_dq table, aggregates RELEVANT and positive
...
# MAGIC dq_rule_no identifies the rule (e.g. DQ_115_NUMERIC_NON_NEGATIVE_tot_rel_bal).
