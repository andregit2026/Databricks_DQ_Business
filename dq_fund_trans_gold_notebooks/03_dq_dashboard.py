...
# MAGIC %md
# MAGIC # DQ Dashboard - fund_trans_gold
# MAGIC
...
print("=" * 70)
print("  DQ DASHBOARD - Overall Summary - fund_trans_gold")
print("=" * 70)
...
spark.sql(f"""
    ...
    WHERE m.source_table = 'fund_trans_gold'
...
print("=" * 70)
print("  DQ DASHBOARD - Per Category - fund_trans_gold")
print("=" * 70)
...
print("=" * 70)
print("  DQ DASHBOARD - Per Rule Detail - fund_trans_gold")
print("=" * 70)
...
print("=" * 70)
print("  BREACH REGISTER - fund_trans_gold - Rules below threshold")
print("=" * 70)
...
spark.sql(f"""
    ...
    WHERE m.source_table = 'fund_trans_gold'
      AND r.dq_number_relevant_records > 0
